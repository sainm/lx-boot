...
@Getter
@Setter
@Schema(description = "常模分数分布表单对象")
public class NormScoreDistributionForm implements Serializable {
    ...
    @NotNull(message = "维度ID（如有分维度常模）不能为空")
    private Long dimensionId;

    @Schema(description = "原始分")
    @NotNull(message = "原始分不能为空")
    ...
    @Size(max=500, message="备注（如转换公式或来源）长度不能超过500个字符")
