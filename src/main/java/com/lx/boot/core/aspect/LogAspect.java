package com.lx.boot.core.aspect;
...
import com.lx.boot.common.util.IPUtils;
import com.lx.boot.core.security.util.SecurityUtils;
import com.lx.boot.system.model.entity.Log;
import com.lx.boot.system.service.LogService;
...
public class LogAspect {
     ...
     * 切点
     */
    @Pointcut("@annotation(com.lx.boot.common.annotation.Log)")
    ...
    public Object doAround(ProceedingJoinPoint joinPoint, com.lx.boot.common.annotation.Log logAnnotation) throws Throwable {
     ...
     * @param userId        用户ID
     */
    private void saveLog(final JoinPoint joinPoint, final Exception e, Object jsonResult, com.lx.boot.common.annotation.Log logAnnotation, long executionTime, Long userId) {
