...
def build_package() -> dict[str, object]:
    ...
    return {
        ...
        "translations": {
            "zh-CN": {"scaleName": "症状自评量表（SCL-90）", "reviewStatus": "DRAFT"},
            "ja-JP": {"scaleName": "症状自評尺度（SCL-90）", "reviewStatus": "DRAFT"},
            "en": {"scaleName": "Symptom Checklist-90 (SCL-90)", "reviewStatus": "DRAFT"},
        },
